...
function compose_cfg { docker-compose -f ./services_new/$1/docker-compose.yml --env-file ./services_new/$1/.env config; }
...
docker stack deploy --with-registry-auth -c  <(compose_cfg mongo)  mongo
